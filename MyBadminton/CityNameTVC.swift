...
class CityNameTVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.accessoryType = cityName[indexPath.row] == selectedCityName ? .checkmark : .none
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "backToAddAddress" {
            ...
            destinationController.cityNameLabel.text = cityName[self.tableView.indexPathForSelectedRow!.row]
